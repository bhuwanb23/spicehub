      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-brand-brown-700">
            Join our community of spice lovers
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-brand-tan p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-brand-brown-900 mb-2">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-brand-brown-900 mb-2">
                Confirm Password
              </label>
              <input
                id="confirm-password"
